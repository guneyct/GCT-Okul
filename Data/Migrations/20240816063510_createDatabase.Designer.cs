...
{
    [DbContext(typeof(Db))]
    [Migration("20240816063510_createDatabase")]
            ...
            modelBuilder.Entity("Data.Entities.Admin", b =>
                {
                    ...
                    b.Property<string>("Username")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "Müdür Kullanıcı Adı");
            ...
            modelBuilder.Entity("Data.Entities.Student", b =>
                {
                    ...
                    b.Property<string>("Username")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "Öğrenci Kullanıcı Adı");
            ...
            modelBuilder.Entity("Data.Entities.Teacher", b =>
                {
                    ...
                    b.Property<string>("Username")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "Öğretmen Kullanıcı Adı");
